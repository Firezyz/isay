	...
	<form class="login-form" action="rest/user/login" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input name="username" id="username" size="25" value="Firezyz" class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" />
			</div>
		</div>
		<div class="form-group">
